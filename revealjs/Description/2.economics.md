...
Cardano has no Auction Mechanics and/or Price Discovery Methods. Later in the future, when other tokens can exist in the network, price discovery methods could be implemented.
---
### Footnotes
